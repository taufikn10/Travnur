    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-8 text-center">
          <img src="{{ url('frontend/images/partner.png') }}" alt="logo-patner" class="img-patner">
        </div>
      </div>
    </div>
  </section>
        ...
        <div class="col-sm-6 col-md-6 col-lg-4">
          <div class="card card-testimonial text-center">
            <div class="testimonial-content">
              ...
              <h3 class="mb-4">Alfon Taekama</h3>
              <p class="testimonial">
        ...
        <div class="col-sm-6 col-md-6 col-lg-4">
          <div class="card card-testimonial text-center">
            <div class="testimonial-content">
              ...
              <h3 class="mb-4">Michael Dam</h3>
              <p class="testimonial">
                “ Never could I have imagined
                the wonderful expperiences
                that awaited me/us/before
                we began our trip “
              </p>
            </div>
            <hr>
        ...
        <div class="col-sm-6 col-md-6 col-lg-4">
          <div class="card card-testimonial text-center">
            <div class="testimonial-content">
              ...
              <h3 class="mb-4">Rafaella Mendes</h3>
              <p class="testimonial">
