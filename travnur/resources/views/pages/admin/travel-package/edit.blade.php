...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Tambah Paket Travel <span>{{ $item->title }}</span></h1>
  </div>
  ...
  <div class="card-body shadow p-3 mb-5 bg-white rounded">
    <form method="POST" action="{{ route('travel-package.update', $item->id) }}" enctype="multipart/form-data">
      @method('PUT')
      @csrf
